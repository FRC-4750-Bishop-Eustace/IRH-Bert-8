...
public class RobotMap {
    ...
    public static final double Feet_PER_PULSE = INCHES_PER_PULSE / 12;
    public static final double WHEEL_Track = 24.5; // diameter of the imaginary circle that the robot spins on 
    public static final double INCHES_PER_DEGREE = Math.PI * WHEEL_DIAMETER / 360.0; // gives the number of inches of travel the wheels have to make a full revolution about which the robot turns
